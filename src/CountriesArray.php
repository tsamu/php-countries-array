...
class CountriesArray{
     ...
     * @return array
     */
    public static function getCountryNonIsoArray():array {
        return array(
     ...
     */
    public function __construct(bool $iso)
    {
        if (!$iso) {
            self::$countries = array_merge(self::getCountryArray(),self::getCountryNonIsoArray());
        } else {
     ...
     * @author Paul Bönisch - <paul.boenisch@umwerk.net>
     */
    public static function getCountries(bool $iso = true): array
    {
        $result = self::getCountryArray();
        if (!$iso) {
            $result = array_merge($result, self::getCountryNonIsoArray());
        }
     ...
     * @author Paul Bönisch - <paul.boenisch@umwerk.net>
     */
    public static function iso(bool $value): CountriesArray
    {
     ...
     *
     */
    public static function get(string $keyField = 'alpha2', string $requestedField = 'name' ): array
    {
        ...
        foreach( self::getCountryArray() as $k => $country ) {
            if ($keyField !== null ) {
     ...
     *
     */
    public static function get2d(string $keyField = 'alpha2', array $requestedFields = array( 'alpha2', 'alpha3', 'num', 'isd', 'name', 'continent' ) ): array
    {
        $supportedFields = array( 'alpha2', 'alpha3', 'num', 'isd', 'name', 'continent' );
        //check if field to be used as array key is passed
        if ( !in_array( $keyField, $supportedFields ) ) {
    ...
    *
    */
    public static function getFromContinent(string $keyField = 'alpha2', string $requestedField = 'name', ?string $continent = null ): array
    {
        $supportedFields = array( 'alpha2', 'alpha3', 'num', 'isd', 'name', 'continent' );
